  ...
  implements IXMLFormat
{
    ...
    @XmlElement(name="Product_Environment")
    private ProductEnvironment productEnvironment;
    ...
    public void createFragments(IRequirementAnalysis rawData)
    {
        ...
        addProductEnvironment(rawData.getProductEnvironment());
   ...
   * @param data The ProductApplication from the original requirement analysis. If null is provided a
   *                  {@link NullPointerException} is thrown.
   *
  ...
  private void addProductApplication(@NotNull IProductApplication data)
  {
    ...
    /**
     * Converts the {@link IProductEnvironment} object to JAXB conform {@link ProductEnvironment} object.
     * @param data The ProductEnvironment from the original requirement analysis. If null is provided a
     * {@link NullPointerException} is thrown.
     *
     * @see IProductEnvironment
     */
  private void addProductEnvironment(@NotNull IProductEnvironment data)
  {
      productEnvironment = new ProductEnvironment(data);
  }
  ...
  {
      ArrayList<IWeightFactor> weightFactorList;
      if (costEstimation != null)
      {
          weightFactorList = costEstimation.getWeightFactors();
      }
      else
      {
          weightFactorList = null;
      }
  ...
  public IProductApplication getProductApplication()
  {
    ...
    /**
     * Get the ProductEnvironment of the CustomXMLFormat
     * Required by IRequirementAnalysis.
     * @return IProductEnvironment.
     */
    ...
    /**
     * Set the ProductEnvironment of the CustomXMLFormat.
     * Required by JAXB.
     * @param productEnvironment ProductEnvironment of the requirement analysis.
     */
