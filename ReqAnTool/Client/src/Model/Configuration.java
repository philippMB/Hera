...
public class Configuration
{
    ...
    {
        workDir = "src/Model/";//System.getProperty("user.dir") + "\\ReqAnTool\\Client\\src\\Model\\";
    ...
    public WeightFactorList<IWeightFactor> adjustOptWeightFactors(RequirementAnalysis myReqAn)
            throws NumberOutOfBoundsException, MissingParameterException
    {
        ...
        else throw new MissingParameterException(MissingParameter.ACTUAL_STATE);
