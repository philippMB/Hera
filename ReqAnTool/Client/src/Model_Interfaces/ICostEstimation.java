...
public interface ICostEstimation 
{
     ...
     * The underlying algorithm is configurable by the model and is given by parameter.
     * @param calculator Calculator which should be used
     */
    void calculateFP(IFPCalculator calculator) throws MissingParameterException;

    /**
     * Calculates the needed ManMonth.
     * A precondition for this calculation is the calculation of the FunctionPoints. The calculator is given by parameter.
     * @param calculator Calculator which should be used
     */
    void calculateManMonth(IMMCalculator calculator) throws MissingParameterException;
